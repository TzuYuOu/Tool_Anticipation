...
# training
parser.add_argument('--model', type=str, choices=['alexnet', 'resnet'], default='alexnet')
...
parser.add_argument('--model_folder', type=str, default='output/experiments/20220508-2356_horizon3_anticipation/models/')
